        ...
        try:
            ...
            try:
                ...
                await message.reply_text(
                    f"<b><i>! Eʀʀᴏʀ, Cᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ ᴛᴏ sᴏʟᴠᴇ ᴛʜᴇ ɪssᴜᴇs @Swordsmith_bot</i></b>\n"
...
async def show_start_message(client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/team_katanashi'),
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/+tZUdk771SDw2MTE1')
        ],
        [
            InlineKeyboardButton('• ᴀʙᴏᴜᴛ', callback_data='about'),
            InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ•', url='https://t.me/Swordsmith_bot')
        ]
    ])
...
async def send_verification_message(client, message: Message):
    ...
    if not shortlink:
        await message.reply_text(
            "Eʀʀᴏʀ ɢᴇɴᴇʀᴀᴛɪɴɢ sʜᴏʀᴛʟɪɴᴋ. Pʟᴇᴀsᴇ ᴛʀʏ ᴀɢᴀɪɴ ʟᴀᴛᴇʀ ᴏʀ ᴄᴏɴᴛᴀᴄᴛ @Swordsmith_bot."
        )
        return None
